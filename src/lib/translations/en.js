export default {
  ...
  "login_list_1": "Using IRMA, in particular using the attribute you received during registration containing your username; this is the easiest way.",
  ...
  "enrollment_email_par1": "Your email address has been verified. You can use this email address later to log in on MyIRMA. Click below to load this address in your IRMA app as an attribute.",
  "enrollment_email_par2": "(Note: your browser must accept cookies in order for MyIRMA to work. If you do not load your email address as attribute now, you can do this later.)",
  "enrollment_email_button": "Load email adres attribute",
  "enrollment_done": "MyIRMA registration finished",
  "enrollment_done_text": "Congratulations! The MyIRMA registration is now finished, and your first IRMA attributes have been loaded in your IRMA app.",
  ...
  "main_emailaddresses_text": "The following email addresses are associated to your account. You can login on MyIRMA using each of these addresses. If you have already {URL=/issuance/email}loaded your email address as IRMA attribute{/URL} you can associate it to your account using the button below.",
